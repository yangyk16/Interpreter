...
#define PRINT_LEVEL_FATAL	1
#define PRINT_LEVEL_TIP		3
#define PRINT_LEVEL_GDBOUT	3
#define PRINT_LEVEL_MASKALL	0

#define ATTRIBUTE_HIDE		1
#define ATTRIBUTE_SYS		2
#define ATTRIBUTE_RDONLY	4
#define ATTRIBUTE_DIR		8
#define ATTRIBUTE_ARCHIVE	0x10
#define ATTRIBUTE_EXE		0x20
